									...
									<div class="central-meta">
										<div class="editing-info">
											...
											<form method="post">
												...
												<div class="form-group">
													<select>
														<option value="country">모임 카테고리 선택</option>


														<option value="ZWE">게임</option>
														<option value="ZWE">음악</option>
														<option value="ZWE">영화</option>
													</select>
												</div>

												<div class="form-group">
													<select>
														<option value="country">모임 지역 선택</option>


														<option value="ZWE">서울</option>
														<option value="ZWE">인천</option>
														<option value="ZWE">경기</option>
													</select>
												</div>

												<div class="form-group">
													<select>
														<option value="country">모임 연령대 선택</option>


														<option value="ZWE">10대</option>
														<option value="ZWE">20대</option>
														<option value="ZWE">30대</option>
													</select>
												</div>
