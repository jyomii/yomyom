							...
							<div class="col-lg-6">
								<div class="central-meta">
									<div class="editing-info">
										<h5 class="f-title"><i class="ti-info-alt"></i> 홍보 글 수정 </h5>
										<form method="post" action="prModifyAction">
										<input type="hidden" name="userKey" value="${boarddata.userKey}" />
										<input type="hidden" name="groupKey" value="${boarddata.groupKey}"  /> 
											<div class="form-group">	
										      <select name="groupKey" required="required" readOnly>
											 
											     <option value="${boarddata.groupKey }" selected>${boarddata.groupName }</option>
											...
											<input type="hidden" id="userId" value="${id}" name="userId" />
											  <textarea rows="4" id="content" name="content" required="required">${boarddata.content}</textarea>
											  <label class="control-label" for="textarea">내용</label><i class="mtrl-select"></i>
											</div>
											<div class="submit-btns">
												<button type="submit" class="mtr-btn"><input type="hidden" name="prKey" value="${boarddata.prKey}" ><span>수정</span></button>
