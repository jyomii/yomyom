...
<section>
											...
											<div class="form-radio">
												<div class="radio">
													<label> <input type="radio" checked="checked"
														name="cmoneytype" value="S"><i class="check-box"></i>신청순
													</label>
												</div>
												<div class="radio">
													<label> <input type="radio" name="cmoneytype" value="M"><i
												...
												<div class="form-group">
													<input type="text" required="required" id="posttitle" name="postTitle"/>
													<label class="control-label" for="input">정모 제목</label><i
														class="mtrl-select"></i>
												</div>
												
												<div class="form-group half halfpercent">
													<input type="text" id="cstartdate" required="required" name="cstartdate"/>
													<label class="control-label" for="input">일시</label><i
														class="mtrl-select"></i>
												</div>
												
												<div class="form-group half halfpercent1">
													<input type="text" id="time" required="required" name="time"/>
													<label class="control-label" for="input">시(0~24)</label><i
														class="mtrl-select"></i>
												</div>
												<div class="form-group half halfpercent1">
													<input type="text" id="minute" required="required" name="minute"/>
													<label class="control-label" for="input">분</label><i
														class="mtrl-select"></i>
												</div>
												<div class="form-group half halfmargin">
													<input type="text" required="required" id="maxperson" name="maxperson"/> <label
														class="control-label" for="input">참석인원(숫자만 입력하세요)</label><i
														class="mtrl-select"></i>
												</div>
												
												<div class="form-group">
													<input type="text" required="required" id="location" name="location"/>
													<label class="control-label" for="input">장소</label><i
														class="mtrl-select"></i>
												</div>
												<div class="form-group">
													<textarea rows="4" id="textarea" required="required" id="grouptext" name="postContent"></textarea>
   ...
   <script>
						...
						<div class="col-lg-3">
							<aside class="sidebar static">
								<jsp:include page="group_rightWidget(nonCal).jsp" />
							</aside>
						</div>
						<!-- 그룹 페이지 위젯 오른쪽 -->
...
$(function() {
  ...
  $("#maxperson").keyup(function(){$(this).val( $(this).val().replace(/[^0-9]/g,"") );} );
  $("#time").keyup(function(){$(this).val( $(this).val().replace(/[^0-9]/g,"") );} );
  $("#minute").keyup(function(){$(this).val( $(this).val().replace(/[^0-9]/g,"") );} );
