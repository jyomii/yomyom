										...
										<div class="d-flex flex-row mt-2">
											...
											<div class="tab-content">
												<div class="tab-pane fade show active" id="basic" >
													<ul class="basics">
														<li><i class="ti-user"></i>이지연</li>
														<li><i class="ti-map-alt"></i>서울특별시 은평구</li>
														<li><i class="ti-mobile"></i>010-1234-5678</li>
														<li><i class="ti-email"></i>alice1305@naver.com</li>
														<li><i class="ti-calendar"></i>2016-08-25</li>
													</ul>
												</div>
