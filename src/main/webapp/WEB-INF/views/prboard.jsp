									...
									<div class="widget">
											...
											<ul class="naves">
												<li>
													...
													<a href="newsfeed.html" title="">운동</a>
												</li>
												<li>
													<i class="ti-mouse-alt"></i>
													<a href="inbox.html" title="">공연</a>
												</li>
												<li>
													<i class="ti-files"></i>
													<a href="fav-page.html" title="">음악</a>
												</li>
												<li>
													<i class="ti-user"></i>
													<a href="timeline-friends.html" title="">취미</a>
												</li>
												<li>
													<i class="ti-image"></i>
													<a href="timeline-photos.html" title="">친목</a>
												</li>
												<li>
													<i class="ti-video-camera"></i>
													<a href="timeline-videos.html" title="">게임</a>
												</li>
								                <li>
								 					<i class="ti-video-camera"></i>
													<a href="timeline-videos.html" title="">공부</a>
												</li>
											</ul>
										</div><!-- Shortcuts -->
									...
									<ul class="nearby-contct">
										<li>
											<div class="nearly-pepls">
												...
												<div class="pepl-info">
													<h4><a href="time-line.html" title="">마포구 걷기 모임</a></h4>
													<span>운동 취미 친목</span>
													<p><br>마포구의 걷기 좋은 산책로를 탐방하고 거니는 마포구민 친목 모임입니다^^<br>
										...
										<li>
											<div class="nearly-pepls">
												...
												<div class="pepl-info">
													<h4><a href="time-line.html" title="">퇴근 후 감성충전</a></h4>
													<span>독서 친목 모임</span>
													<p><br>퇴근 후 직장인들끼리 모여 같이 책을 읽고 대화하는 모임입니다^^<br>
													   매 달 한 권의 책을 선정하여 읽고 마지막 주 금요일에는 같이 토론도 해보아요~^^
													</p>
													<a href="#" title="" class="add-butn" data-ripple="">가입하기</a>
												</div>
											</div>
										...
										<li>
											<div class="nearly-pepls">
												...
												<div class="pepl-info">
													<h4><a href="time-line.html" title="">오늘은 영어왕</a></h4>
													<span>공부 언어 모임</span>
													<p><br>더 이상 미룰 수 없다! 오늘은 영어왕이 되기 위한 사람들이 모인 곳!<br>
										...
										<li>
											<div class="nearly-pepls">
												...
												<div class="pepl-info">
													<h4><a href="time-line.html" title="">공연이 좋다</a></h4>
													<span>음악 공연 연극 친목</span>
													<p><br>같이 공연 보러 갈 사람을 구하고 싶을 때! 우리 모임에서 함께 가요^^<br>
													</p>
													<a href="#" title="" class="add-butn" data-ripple="">가입하기</a>
												</div>
											</div>
										...
										<ul class="followers">
											...
											<li>
												...
												<div class="friend-meta">
													<h4><a href="time-line.html" title="">광진구 자전거 매니아</a></h4>
												</div>
											</li>
											<li>
												<figure><img src="images/resources/friend-avatar4.jpg" alt=""></figure>
												<div class="friend-meta">
													<h4><a href="time-line.html" title="">무초 구스또!</a></h4>
												</div>
											</li>
											<li>
												<figure><img src="images/resources/friend-avatar6.jpg" alt=""></figure>
												<div class="friend-meta">
													<h4><a href="time-line.html" title="">옵치고고</a></h4>
												</div>
											</li>
											<li>
												<figure><img src="images/resources/friend-avatar8.jpg" alt=""></figure>
												<div class="friend-meta">
													<h4><a href="time-line.html" title="">치킨먹자 배그냠냠</a></h4>
												</div>
											</li>
											...
											<div class="widget">
												...
												<button type="button" class="mtr-btn"><span><h4>모임 홍보하기</h4></span></button>
