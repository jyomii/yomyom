											...
											<li>
												<div class="nearly-pepls">
													...
													<div class="pepl-info">
														...
														<a class="add-butn" data-toggle="modal" data-target="#prModal">상세보기</a>
													</div>
												</div> <!-- 게시글 모달로 보기 -->
														...
														<div class="modal-content">
															...
															<div class="modal-body">
																<form name=pr_join_form method=post>
																		<div class="viewpage">
																			<div class="prtitle">
																			    <span>마포구를 중심으로 활동중인 친목 모임</span>
																				<p>이지연</p>
																				
																			</div>
																			<div class="prcontent">
																				<p>마포구의 걷기 좋은 산책로를 탐방하고 
																				       날이 좋을 때 번개 모임도 갖기도 합니다^^
																				       동네 친구 만들기에 딱! 놀러오세요~~ <br>
																				       마포구의 걷기 좋은 산책로를 탐방하고 
																				       날이 좋을 때 번개 모임도 갖기도 합니다^^
																				       동네 친구 만들기에 딱! 놀러오세요~~ <br>
																				       마포구의 걷기 좋은 산책로를 탐방하고 
																				       날이 좋을 때 번개 모임도 갖기도 합니다^^
																			...
																			<div class=prsubmit>
																				...
																				<button type="button" data-dismiss="modal" class="add-butn">닫기</button>
																			</div>
																		</div>
																</form>
															</div>
