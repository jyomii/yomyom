		...
		function init_echarts() {
			...
			if ($('#mainb').length ){
				  ...
				  echartBar.setOption({
					...
					series: [{
					  name: '가입자 수',
					  type: 'bar',
					  data: [2.0, 5.0, 7.0, 23.2, 25.6, 76.7, 135.6],
					  markPoint: {
						data: [{
						  type: 'max',
						  name: '???'
			...
			if ($('#echart_bar_horizontal').length ){ 
			  ...
			  echartBar.setOption({
				...
				yAxis: [{
				  type: 'category',
				  data: ['리그오브레전드', '오버워치', '바람의나라', '스타크래프트', '카트라이더', '배틀그라운드']
				}],
				series: [{
				  name: '모임 수',
				  type: 'bar',
